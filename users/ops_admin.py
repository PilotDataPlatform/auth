    ...
    def get(self):
        ...
        try:
            ...
            ops_db = psycopg2.connect(
                database=ConfigSettings.RDS_DBNAME,
                user=ConfigSettings.RDS_USER,
                password=ConfigSettings.RDS_PWD,
                host=ConfigSettings.RDS_HOST,
                port=ConfigSettings.RDS_PORT,
            )
            cursor = ops_db.cursor()
            table = f"{ConfigSettings.RDS_SCHEMA_DEFAULT}.user_invitation"
