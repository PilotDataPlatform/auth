...
##  Running the service
Service auth requires a keycloak instance to connect to. Set the related keycloak variables in .env, see .env.schema for reference.
...
- API documentation: http://localhost:5060/v1/api-doc


### How to use the service for authentication
* login
```
